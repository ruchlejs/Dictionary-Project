...
int main(int argc, char *argv[])
{
  ...
  hashlset_mystring_t table = hashlset_mystring_new(10, fhashchage, mystring_fprintf, mystring_delete, mystring_equal);
  mystring s;
  char mot_dct[50];
    ...
    while (mot != NULL)
    {
      ...
      if (mot[0] != '"')
      {
        ...
        if (s[0] < 123 && s[0] > 96)
        {
          ...
          debut = clock();
          presence = hashlset_mystring_find_key(s, table);
          fin = clock();
